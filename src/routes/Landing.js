          ...
          <div className="landing-container flex-grow-1">
            <div className="col-12 col-lg-6">
              <div className="row" style={{ marginBottom: '9px' }}>
                <div>
                  <h1 className="fw-bol">Soy Higia, una Persona Digital Hiperrealista creada por Digital Solvers, con el propósito de aclarar tus dudas sobre los tratamientos de UCB.</h1>
                </div>
              </div>
              <div className="row">
                <div>
